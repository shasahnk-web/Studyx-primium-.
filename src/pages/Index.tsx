...
const Index = () => {
  ...
  const fetchNotes = async (): Promise<Note[]> => {
    return [
      { id: '1', title: 'Physics Notes', subject: 'Physics', batch_id: '1', pdf_url: '#' },
      { id: '2', title: 'Chemistry Notes', subject: 'Chemistry', batch_id: '1', pdf_url: '#' }
    ];
  };

  const fetchDPPs = async (): Promise<DPP[]> => {
    return [
      { id: '1', title: 'Math DPP', subject: 'Mathematics', batch_id: '2', pdf_url: '#' },
      { id: '2', title: 'Biology DPP', subject: 'Biology', batch_id: '2', pdf_url: '#' }
    ];
  };
